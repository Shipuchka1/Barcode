var FormComponents = function () {
    ...
    var handleSelect2 = function () {
        ...
        $("#select2_sample6").select2({
            ...
            minimumInputLength: 1,
            ajax: { // вместо того чтобы писать функцию для выполнения просьбы мы используем удобную помощника Select2's
                ...
                results: function (data, page) { // анализа результатов в формат, ожидаемый  Select2.
...
data: {apikey: "ju6z9mjyajq2djue3gbvv26t"},dataType: "jsonp"}).done(function (data) {
                        callback(data);
                    });
                }
            },
